...
def train():
    ...
    sv = tf.train.Supervisor(logdir='/home/dsl/all_check/face_detect/voc-aug', summary_op=None, init_fn=restore)
...
def detect():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, '/home/dsl/all_check/face_detect/voc-aug/model.ckpt-3310')
