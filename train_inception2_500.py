...
def train():
    ...
    pred_loc, pred_confs, vbs = inception_500_dsl.inception_v2_ssd(img,config)
    ...
    sv = tf.train.Supervisor(logdir='/home/dsl/all_check/face_detect/voc-512-iv2-nn', summary_op=None, init_fn=restore)
...
def detect():
    ...
    with tf.Session() as sess:
        ...
        saver.restore(sess, '/home/dsl/all_check/face_detect/voc-512-iv2-nn/model.ckpt-10189')
...
def video():
    ...
    with tf.Session() as sess:
        sess.run(tf.global_variables_initializer())
        saver.restore(sess, '/home/dsl/all_check/face_detect/iv2_500/model.ckpt-83094')
