...
class CoordConv(base.Layer):
    ...
    def call(self, input_tensor,num_outputs=32,kernel_size=3,activation_fn=slim.nn.relu):
        ret = self.addcoords(input_tensor)
        ret = slim.conv2d(input_tensor,num_outputs=num_outputs,kernel_size=kernel_size,activation_fn=activation_fn)
        return ret